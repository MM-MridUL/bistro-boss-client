 ...
 * 5. create payment intent post on the sever. and return client secret.
 * install stripe on the server and get client secret. maker sure you used the payment method types:['card']
